...
local last_ver = ver_s:option(Value, "last_upgrade_version", "当前固件版本")
last_ver.readonly = true
local last_ts = ver_s:option(Value, "last_upgrade_ts", "上次升级时间")
last_ts.readonly = true
